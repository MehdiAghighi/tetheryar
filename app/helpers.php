...
function sendOtpCode($mobile , $code)
{
    ...
    try {
        ...
        $APIKey = "ee65e6da19c2cbd2657e6da";
        $SecretKey = "925400162Innofin";
...
function sendTrackingCode($mobile , $code)
{
...
function sendTrackingCodeTether($mobile , $code)
{
...
function sendVerifyPay($mobile , $code , $tetherAmount)
{
    ...
    try {
        ...
        $data = array(
            "ParameterArray" => array(
                ...
                array(
                    "Parameter" => "TetherAmount",
                    "ParameterValue" => $tetherAmount
                ),
...
function smsVerifySellRequest($mobile , $code)
{
...
function smsRejectedSellRequest($mobile , $code)
{
...
function smsAdminBuyRequest($code , $mobile)
{
...
function smsAdminSellRequest($code , $mobile)
{
...
function smsAdminNewAuth($code , $mobile)
{
...
function smsAuthApproved($mobile , $name)
{
...
function smsAuthRejected($mobile , $name)
{
...
function smsAuthPendingForPhone($mobile , $name)
{
