                            ...
                            <div class="page-next">
                                <nav aria-label="breadcrumb" class="d-inline-block">
                                    <ul class="breadcrumb bg-white rounded shadow mb-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{route('client.buy.step1.create')}}">خرید تتر </a></li>
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <div class="section-title">
                                ...
                                <p>
                                    قیمت خرید تتر از سایت : <span class="fw-bolder"> {{number_format($buyPrice)}} تومان</span>
                                </p>
                            </div>
                        </div>
                        <input type="hidden" id="buyTetherPrice" value="{{$buyPrice}}">
                        <div class="content mt-4 pt-2">
                            <form action="{{route('client.buy.step1.store')}}" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <input class="form-control ps-5" autocomplete="off" type="number" step="1" name="toman_amount" value="{{old('toman_amount')}}" placeholder="مبلغ به تومان" id="toman_amount">
                                                <div class="mt-1">
                                                    <div id="toman_persian" class="small d-inline"> </div>
                                                    <span id="toman" class="small mr-1 text-danger" style="display: none">تومان می دهید</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!--end col-->
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-icon position-relative">
                                                ...
                                                <input name="tether_amount" class="form-control ps-5" autocomplete="off" type="number"  value="{{old('tether_amount')}}" placeholder="مقدار تتر" id="tether_amount" step=".01"
                                                       oninput="setCustomValidity('')">
                                                <div class="mt-1">
                                                    <div id="tether_persian" class="small d-inline"> </div>
                                                    <span id="tether" class="small mr-1 text-success" style="display: none">تتر دریافت می کنید</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!--end col-->
...
@section('script')
    ...
    <script>
        ...
        $('#toman_amount').keyup(function() {
            ...
            var tetherPrice =$('#buyTetherPrice').val();
        ...
        $('#tether_amount').keyup(function() {
            ...
            var tetherPrice =parseInt($('#buyTetherPrice').val());
